...
The sum of unique native units that transacted at least once in the trailing 4 Years up to that interval. Native units that transacted more than once are only counted once.

| Name                 | MetricID   | Category | Subcategory | Type | Unit         | Interval |
| -------------------- | ---------- | -------- | ----------- | ---- | ------------ | -------- |
| 4 Year Active Supply | SplyAct4yr | Supply   | Active      | Sum  | Native units | 4 years  |
...
{% embed url="https://coverage.coinmetrics.io/asset-metrics/SplyAct4yr" %}
