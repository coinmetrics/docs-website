...
The sum of unique native units that transacted at least once in the trailing 2 Years up to that interval. Native units that transacted more than once are only counted once.

| Name                 | MetricID   | Category | Subcategory | Type | Unit         | Interval |
| -------------------- | ---------- | -------- | ----------- | ---- | ------------ | -------- |
| 2 Year Active Supply | SplyAct2yr | Supply   | Active      | Sum  | Native units | 2 years  |
...
{% embed url="https://coverage.coinmetrics.io/asset-metrics/SplyAct2yr" %}
