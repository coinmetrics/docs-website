...
The sum of unique native units that transacted at least once in the trailing 7 days up to that interval. Native units that transacted more than once are only counted once.

| Name                | MetricID  | Category | Subcategory | Type | Unit         | Interval |
| ------------------- | --------- | -------- | ----------- | ---- | ------------ | -------- |
| 7 Day Active Supply | SplyAct7d | Supply   | Active      | Sum  | Native units | 7 days   |
...
{% embed url="https://coverage.coinmetrics.io/asset-metrics/SplyAct7d" %}
