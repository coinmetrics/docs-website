# 10 Year Active Supply

## Definition

The sum of unique native units that transacted at least once in the trailing 10 Years up to that interval. Native units that transacted more than once are only counted once.

| Name                  | MetricID    | Category | Subcategory | Type | Unit         | Interval |
| --------------------- | ----------- | -------- | ----------- | ---- | ------------ | -------- |
| 10 Year Active Supply | SplyAct10yr | Supply   | Active      | Sum  | Native units | 10 years |
...
{% embed url="https://coverage.coinmetrics.io/asset-metrics/SplyAct10yr" %}
