...
The sum of unique native units that transacted at least once in the trailing 1 day up to that interval. Native units that transacted more than once are only counted once.

| Name | MetricID | Category | Subcategory | Type | Unit | Interval |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| 1 Day Active Supply | SplyAct1d | Supply | Active | Sum | Native units | 1 days |
...
{% embed url="https://docs.coinmetrics.io/info/metrics/SplyAct1d" %}
