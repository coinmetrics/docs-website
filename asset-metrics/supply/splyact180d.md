...
The sum of unique native units that transacted at least once in the trailing 180 days up to that interval. Native units that transacted more than once are only counted once.

| Name                  | MetricID    | Category | Subcategory | Type | Unit         | Interval |
| --------------------- | ----------- | -------- | ----------- | ---- | ------------ | -------- |
| 180 Day Active Supply | SplyAct180d | Supply   | Active      | Sum  | Native units | 180 days |
...
{% embed url="https://coverage.coinmetrics.io/asset-metrics/SplyAct180d" %}
