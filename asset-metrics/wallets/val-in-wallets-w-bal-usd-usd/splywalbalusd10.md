...
| ------------------------------------------------- | --------------- | -------- | ----------- | ---- | ---- | -------- |
| Supply, in wallets with balance, greater than $10 | SplyWalBalUSD10 | Wallets  | Balance     | Sum  | USD  | 1 day    |
...
{% embed url="https://docs.coinmetrics.io/info/metrics/SplyWalBalUSD10" %}
