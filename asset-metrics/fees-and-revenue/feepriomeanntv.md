...
The average (mean) Miner Tip, a.k.a. _priority fee,_ paid for transactions during a time interval (e.g. 1 day), shown in native units (e.g. units of ETH).
...
| ----------------------------- | -------------- | ---------------- | ----------- | ---- | ------------ | ------------- |
| Mean Miner Tip (native units) | FeePrioMeanNtv | Fees and revenue | Fees        | Mean | Native units | 1 day, 1 hour |
...
<figure><img src="../../.gitbook/assets/ETH_Total_Gas_Used_Mean_Priority_Fee (1).png" alt=""><figcaption></figcaption></figure>
