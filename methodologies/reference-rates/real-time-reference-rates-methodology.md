...
11. **Version 0.4 on February 27, 2020**: The coverage universe is expanded to include the following assets: `xaut`, `paxg`, `husd`, `dgx`, `busd`, `ftt`, `hedg`, `okb`, `zb`, `hbar`, `ckb`, `mof`, `vsys`, `cennz`, `luna`, `chz`, `seele`, `dx`, `matic`, `abbc`, `rif`, `tomo`, `hpt`, and `ant`.
...
13. **Version 0.2 on December 9, 2019**: Updated calculation methodology to include price inverse variance weighting to reduce the impact of outliers. The coverage universe is expanded to include the following assets: `algo` and `beam`.
14. **Version 0.1 on August 30, 2019**: Initial publication of Real-Time Reference Rates Methodology.
